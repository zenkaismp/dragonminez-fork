...
dependencies {
    ...
    implementation("io.netty:netty-codec:4.2.16.Final") { because("Security/compat override requested.") }
    implementation("io.netty:netty-handler:4.2.16.Final") { because("Security/compat override requested.") }
